...
cityData.forEach(function (city) {
    ...
    L.circleMarker(city.location, {
        ...
        .bindPopup("<h2>" + city.city + ", " + city.state + "</h2> <hr> <h3>Population " + city.population.toLocaleString() // format the population with a thousands separator by using the toLocaleString() method on the city.population in the bindPopup() method
            + "</h3>")
        .addTo(map);
});
